...
local function logic_do_deal(dealer, msg)
    ...
    local function test_deal()
        ...
        local tempCards = {
            ...
            {0x02,0x03,0x04,0x05,0x06,0x08,0x07,0x09,0x0a,0x0b,0x0c,0x0d,0x0e},
            {0x4f,0x5f,0x12,0x15,0x25,0x35,0x1c,0x2c,0x26,0x27,0x28,0x29,0x2a},
            {0x25,0x0c,0x1c,0x13,0x14,0x08,0x0e,0x2e,0x3b,0x1b,0x0b,0x12,0x32},
            {0x07,0x0a,0x2a,0x02,0x22,0x24,0x34,0x03,0x35,0x37,0x36,0x3c,0x3e},
        }
        for i=1, PLAYER_NUMBER do
            local stPlayer = stGameState:GetPlayerByChair(i)
            if stPlayer then
