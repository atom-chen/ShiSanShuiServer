...
-- 返回 STEP_FAILED 流程终止
local function logic_do_player_other_quadruplet(stPlayer, msg)
    LOG_DEBUG("Run LogicStep do_player__quadruplet_other")
...
return logic_do_player_other_quadruplet
