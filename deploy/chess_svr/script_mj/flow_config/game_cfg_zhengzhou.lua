...
local GameCfg =  {
       ...
       RoomSetting = {
            ...
            nNoCardWinCount = 1,
            nNoCardGangCount = 0,
            stringEncoding = "flow_config.string_encoding_cn_zhengzhou"
        },
        TimerSetting = {
            readyTimeOut = 10,          -- -1为不超时一直等
            giveTimeOut = 15,           -- 出牌超时时间(秒)
            blockTimeOut = 10,          -- 处理挡牌时间
			XiaPaoTimeOut = 7,          -- 下跑超时时间
        ...
        FlowSetting = {
            strDealer = "core.dealer_zhengzhou",
            strFlowDealer = "../script_mj/flow_config/flow_dealer_zhengzhou.json",
            strFlowPlayer = "../script_mj/flow_config/flow_player_zhengzhou.json",
            strFlowPlayerExt = "../script_mj/flow_config/flow_player_ext_zhengzhou.json",
        },
        -- slot
        GameSlotSetting = {
