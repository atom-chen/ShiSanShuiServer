...
local GameCfg =  {
       ...
       RoomSetting = {
        ...
        FlowSetting = {
            ...
            strFlowDealer = "../script_thirteen_puxian/flow_config/flow_dealer_thirteen.json",
            strFlowPlayer = "../script_thirteen_puxian/flow_config/flow_player_thirteen.json",
            strFlowPlayerExt = "../script_thirteen_puxian/flow_config/flow_player_thirteen_ext.json",
        },
}
