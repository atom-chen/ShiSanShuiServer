...
function SSMessage.CallPlayerChooseCardType(stPlayer)
    SSMessage.FlowInternalEvent(stPlayer, "call_choose_cardtype");
end

function SSMessage.CallPlayerMult(stPlayer)
    SSMessage.FlowInternalEvent(stPlayer, "call_mult");
end
