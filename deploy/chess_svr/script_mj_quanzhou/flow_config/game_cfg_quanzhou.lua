...
local GameCfg =  {
       nLeftCardNeedQuict = 16,         --剩余多少张牌算荒局
       nMoneyMode = MONEY_MODE_MONEY,   --默认是金币声，传配置则是房卡场
       nPlayerNum = 4,
       nJuNum     = 2,      -- 一圈多少局（房卡模式）
       nCurrJu    = 1,      -- 当前是第几局
       rno        = 0,      -- 房号
       CardPoolType =  {"char", "bamboo", "ball","wind", "jian", "flower"},
       RoomSetting = {
            nChargeMode = CHARGE_MODE_FREE,
            nGameStyle = GAME_STYLE_QUANZHOU,         -- 游戏类型  大众 四川等
        ...
        FlowSetting = {
            ...
            strFlowDealer = "../script_mj_quanzhou/flow_config/flow_dealer_fuzhou.json",
            strFlowPlayer = "../script_mj_quanzhou/flow_config/flow_player_fuzhou.json",
            strFlowPlayerExt = "../script_mj_quanzhou/flow_config/flow_player_ext_fuzhou.json",
        },
        -- slot
        GameSlotSetting = {
            --牌库
