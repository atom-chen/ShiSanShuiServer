...
-- 通知游戏开始
function CSMessage.NotifyAllPlayerStartGame(nCfgTing)
    --设置游戏已经开始标志
    stRoundInfo:SetJuStart(1)
    --开始游戏时跳过judge_robgold_end
    stRoundInfo:SetSkipRob(true)
    local para = {
        bIsNeedTing = nCfgTing,
    }
    CSMessage.NotifyAllPlayer(nil, "game_start", para)
end
function CSMessage.NotifyOnePlayerStartGame(stPlayer,nCfgTing)
    --设置游戏已经开始标志
    stRoundInfo:SetJuStart(1)
    local para = {
        bIsNeedTing = nCfgTing,
    }
    CSMessage.NotifyOnePlayer(stPlayer, "game_start", para)
end
function CSMessage.NotifyOnePlayerStartFlag(stPlayer,nCfgTing)
    --设置游戏已经开始标志
