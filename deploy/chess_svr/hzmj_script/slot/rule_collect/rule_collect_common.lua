...
function slot.CanCollect(stPlayerCardArray, nCard)
    ...
    if Array.Exist(stPlayerCardArray, nCard - 1) and
        ...
        if LibLaiZi:IsLaiZi(nCard - 1) == false and LibLaiZi:IsLaiZi(nCard - 2) == false then
            return true
        end
    end
    ...
    if Array.Exist(stPlayerCardArray, nCard - 1) and
        ...
        if LibLaiZi:IsLaiZi(nCard - 1) == false and LibLaiZi:IsLaiZi(nCard + 1) == false then
            return true
        end
    end
...
function slot.GetCollectGroup( stPlayerCardArray, nCard )
    ...
    if Array.Exist(stPlayerCardArray, nCard - 1) and
        Array.Exist(stPlayerCardArray, nCard - 2)  then
        if LibLaiZi:IsLaiZi(nCard - 1) == false and LibLaiZi:IsLaiZi(nCard - 2) == false then
            table.insert(group, { nCard - 2,  nCard - 1})
        end
    end
    if Array.Exist(stPlayerCardArray, nCard - 1) and
        Array.Exist(stPlayerCardArray, nCard + 1)  then
        if LibLaiZi:IsLaiZi(nCard - 1) == false and LibLaiZi:IsLaiZi(nCard + 1) == false then
            table.insert(group, { nCard - 1,  nCard +1})
        end
    end
    ...
    if Array.Exist(stPlayerCardArray, nCard + 1) and
        Array.Exist(stPlayerCardArray, nCard + 2)  then
        if LibLaiZi:IsLaiZi(nCard + 1) == false and LibLaiZi:IsLaiZi(nCard + 2) == false then
            table.insert(group, { nCard + 1,  nCard + 2})
        end
    end
    return group
end
