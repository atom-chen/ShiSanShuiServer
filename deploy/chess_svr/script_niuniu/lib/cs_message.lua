...
function CSMessage.NotifyPlayerEnterTo(stPlayerEnter, stPlayerTo)
    ...
    -- LOG_DEBUG("GID=%d, cfg=%s", GGameCfg.gid, vardump(GGameCfg));
...
-- function CSMessage.NotifyPlayerMultTo(stPlayerFrom, stPlayerTo)
--     local nFromChairId = stPlayerFrom:GetChairID()
--     local nBeishu = LibMult:GetPlayerMult(nFromChairId)
--     if nBeishu ~= -1 then
--         local para = {}
--         para["p" ..i] = nBeishu
--         CSMessage.NotifyOnePlayerTo(stPlayerTo, "mult", para, nFromChairId)
--     end
-- end
