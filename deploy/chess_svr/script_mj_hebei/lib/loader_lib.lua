...
function LoaderLib.LoadAll()
    ...
    LibGameLogicLangFang = import("lib.lib_game_logic_langfang").new()
    LibGameLogicTangShan = import("lib.lib_game_logic_tangshan").new()
...
function LoaderLib.CreateInitAll()
    ...
    bRetCode =  CSMessage.CreateInit()
                        ...
                        and LibGameLogicLangFang:CreateInit()
                        and LibGameLogicTangShan:CreateInit()
...
function LoaderLib.StartGameInitAll()
    ...
    LibGameLogicLangFang:OnGameStart()
    LibGameLogicTangShan:OnGameStart()
