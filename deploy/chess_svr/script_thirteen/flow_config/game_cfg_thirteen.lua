...
local GameCfg =  {
       ...
       RoomSetting = {
            ...
            nMaxWaterScore = 8,
            stringEncoding = "flow_config.string_encoding_cn_thirteen"
        },

        --定时时间
        TimerSetting = {
            readyTimeOut = 300,              -- -1则不设定定时器 不超时一直等
        ...
        FlowSetting = {
            ...
            strFlowDealer = "../script_thirteen/flow_config/flow_dealer_thirteen.json",
            strFlowPlayer = "../script_thirteen/flow_config/flow_player_thirteen.json",
            strFlowPlayerExt = "../script_thirteen/flow_config/flow_player_thirteen_ext.json",
        },
}
