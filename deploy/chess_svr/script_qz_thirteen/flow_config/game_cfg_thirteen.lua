...
local GameCfg =  {
       ...
       RoomSetting = {
        ...
        FlowSetting = {
            ...
            strFlowDealer = "../script_qz_thirteen/flow_config/flow_dealer_thirteen.json",
            strFlowPlayer = "../script_qz_thirteen/flow_config/flow_player_thirteen.json",
            strFlowPlayerExt = "../script_qz_thirteen/flow_config/flow_player_thirteen_ext.json",
        },
}
