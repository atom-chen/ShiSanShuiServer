...
local GameCfg =  {
       ...
       RoomSetting = {
        ...
        FlowSetting = {
            ...
            strFlowDealer = "../zzmj_script/flow_config/flow_dealer_zhengzhou.json",
            strFlowPlayer = "../zzmj_script/flow_config/flow_player_zhengzhou.json",
            strFlowPlayerExt = "../zzmj_script/flow_config/flow_player_ext_zhengzhou.json",
        },
        -- slot
        GameSlotSetting = {
